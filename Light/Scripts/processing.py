...
j.crop("Hg_test(7).png", "white-mercury_.png")
j.crop("HeatingLamp_blue.png", "HeatingLamp_blue_.png")
j.crop("HeatingLamp_green.png", "HeatingLamp_green_.png")
j.crop("HeatingLamp_red.png", "HeatingLamp_red_.png")
j.crop("HeatingLamp_white.png", "HeatingLamp_white_.png")
j.crop("HeatingLamp_yellow.png", "HeatingLamp_yellow_.png")

k = -0.6536882755009491
b = 634.2494413120518
mc, l = j.readIntensity("white-mercury_.png", "plot-white-mercury", "Ртутная лампа", "Белый лист")
mcb, l = j.readIntensity("HeatingLamp_blue_.png", "plot-blue-heating", "Лампа накаливания", "Синий лист")
mcg, l = j.readIntensity("HeatingLamp_green_.png", "plot-green-heating", "Лампа накаливания", "Зелёный лист")
mcr, l = j.readIntensity("HeatingLamp_red_.png", "plot-red-heating", "Лампа накаливания", "Красный лист")
mcw, l = j.readIntensity("HeatingLamp_white_.png", "plot-white-heating", "Лампа накаливания", "Белый лист")
white = l
mcy, l = j.readIntensity("HeatingLamp_yellow_.png", "plot-yellow-heating", "Лампа накаливания", "Жёлтый лист")
yellow = l
blue = mcb[:, 2] * 0.1144
red = mcr[:, 0] * 0.2989
green = mcg[:, 1] * 0.5866
