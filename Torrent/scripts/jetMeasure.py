...
try:
    ...
    with open("/home/guest/Desktop/Kuznetsova/jet-starter-kit (3)/data/100mm.txt", "w") as f:
        f.write("- Jet Lab\n\n")
        f.write("Date: " +str( time.localtime(time.time()))+ "\n")
        f.write("Step: 5 motor steps \n\n")
        print(*measures, file=f, sep="\n")
    with open("/home/guest/Desktop/Kuznetsova/jet-starter-kit (3)/data/x.txt", "w") as f:
        print(*x, file=f, sep="\n")
